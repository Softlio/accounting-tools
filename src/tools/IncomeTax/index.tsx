  ...
  id
    ...
    return (
      ...
      >
        ...
        <button disabled={isSubmitting} onClick={onPrint} className="mt-4 disabled:cursor-progress disabled:grayscale bg-theme-primary hover:bg-theme-secondary transition-colors flex items-center gap-2 text-white py-2 px-3 rounded-md absolute top-0 right-4">
          {isSubmitting ? <LoaderIcon /> : <PrinterIcon />}  {translations.incomeTaxTool.print}
        </button>
      </TabContainer>
    );
  };
