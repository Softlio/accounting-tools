...
export const LoginForm = () => {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    if (response?.error) {
      form.setError("email", {
        type: "manual",
        message: translations.login.form.email,
      });
    }
  }
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder={translations.login.form.emailPlaceholder}
                  {...field}
                />
              </FormControl>
              <FormDescription>
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  type="password"
                  placeholder={translations.login.form.passwordPlaceholder}
                  {...field}
                />
              </FormControl>
              <FormMessage />
        ...
        >
          {translations.login.form.submit}
        </Button>
      </form>
    </Form>
  );
