...
import {
  IncomeTaxResultValues,
  calculateIncomeTax,
} from "@/lib/calculate-income-tax";
...
const IncomeTaxSection = () => {
  ...
  return (
    <section
      id="inkomsten-belasting"
      className="py-16 md:px-4 flex flex-col gap-8"
    >
      <div className="container mx-auto flex flex-col gap-2">
        <Title type="h2" className="text-4xl leading-none">
          {translations.incomeTaxTool.title}
        </Title>
          ...
          <Card className="max-w-xl flex flex-col gap-2 p-6">
            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>
                    {translations.incomeTaxTool.dialog.title}
                  </DialogTitle>
                  <DialogDescription>
                ...
                <Input
                  name="name"
                  type="text"
                  placeholder={translations.incomeTaxTool.dialog.name}
                  className="w-full"
                  value={name}
                  onChange={(e) => {
                ...
                <Button
                  className="text-2xl font-bold px-8 py-6 w-full bg-theme-secondary font-serif"
                  onClick={order}
